...
//				sheet.mergeCells()
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        else if(item instanceof jxl.write.Boolean)
                            sheet.addCell(new jxl.write.Boolean(i, j + 1, (java.lang.Boolean)item, arial12format));
                        else if(item instanceof jxl.write.Number)
                            sheet.addCell(new jxl.write.Number(i, j + 1, ((java.lang.Number) item).doubleValue(), arial12format));
                        else
